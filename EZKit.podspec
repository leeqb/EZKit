#
#  Be sure to run `pod spec lint EZKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "EZKit"
  s.version      = "0.0.1"
  s.summary      = "Easy for developement"
  ...
  s.homepage     = "https://github.com/leeqb/EZKit"
  ...
  # s.authors            = { "leeqb" => "252262021@qq.com" }
  ...
  s.source       = { :git => "https://github.com/leeqb/EZKit.git", :tag => s.version, :submodules => true, :commit => "cb457a99016911e2b0f12c670e636cb09c459059" }
  ...
  s.source_files  = "EZKit/Classes/EZKit.h"
  #s.exclude_files = "EZKit/Classes/Exclude"

  s.public_header_files = "EZKit/Classes/EZKit.h"
